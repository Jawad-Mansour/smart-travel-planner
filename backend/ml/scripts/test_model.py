    ...
    samples = pd.DataFrame([
        {
            ...
            'avg_annual_temp_c': 20.0, 'seasonal_range_c': 15.0,
            'cost_per_day_avg_usd': 35, 'meal_budget_usd': 4,
            'hotel_night_avg_usd': 25, 'flight_cost_usd': 800,
            'museum_count': 8, 'monument_count': 12, 'festival_score': 7,
            'beach_score': 1, 'scenic_score': 8, 'wellness_score': 3,
            'culture_score': 6, 'hiking_score': 9, 'nightlife_score': 4,
            'family_score': 3, 'luxury_score': 1, 'safety_score': 7,
            'tourist_density_score': 5, 'adventure_sports_score': 9,
            'near_mountains': 1, 'near_beach': 0,
            'region': 'South Asia', 'dry_season_months': 'Oct,Nov,Dec,Jan,Feb,Mar',
            'best_season': 'Oct-Nov', 'visa_requirement': 'Visa on Arrival',
            'english_friendly_score': 6, 'public_transport_score': 4,
            'latitude': 27.7172, 'longitude': 85.3240
        },
        {
            # Paris - Should be Culture
            'avg_annual_temp_c': 13.0, 'seasonal_range_c': 14.0,
            'cost_per_day_avg_usd': 180, 'meal_budget_usd': 25,
            'hotel_night_avg_usd': 150, 'flight_cost_usd': 350,
            'museum_count': 130, 'monument_count': 80, 'festival_score': 9,
            'beach_score': 2, 'scenic_score': 7, 'wellness_score': 5,
            'culture_score': 10, 'hiking_score': 1, 'nightlife_score': 8,
            'family_score': 6, 'luxury_score': 8, 'safety_score': 8,
            'tourist_density_score': 9, 'adventure_sports_score': 1,
            'near_mountains': 0, 'near_beach': 0,
            'region': 'Western Europe', 'dry_season_months': 'Apr,May,Jun,Sep,Oct',
            'best_season': 'Apr-Jun', 'visa_requirement': 'Schengen Visa',
            'english_friendly_score': 6, 'public_transport_score': 10,
            'latitude': 48.8566, 'longitude': 2.3522
        },
        {
            # Maldives - Should be Luxury
            'avg_annual_temp_c': 28.0, 'seasonal_range_c': 3.0,
            'cost_per_day_avg_usd': 300, 'meal_budget_usd': 30,
            'hotel_night_avg_usd': 280, 'flight_cost_usd': 900,
            'museum_count': 1, 'monument_count': 1, 'festival_score': 2,
            'beach_score': 10, 'scenic_score': 8, 'wellness_score': 9,
            'culture_score': 2, 'hiking_score': 1, 'nightlife_score': 2,
            'family_score': 6, 'luxury_score': 10, 'safety_score': 9,
            'tourist_density_score': 4, 'adventure_sports_score': 3,
            'near_mountains': 0, 'near_beach': 1,
            'region': 'South Asia', 'dry_season_months': 'Dec,Jan,Feb,Mar,Apr',
            'best_season': 'Dec-Apr', 'visa_requirement': 'Visa on Arrival',
            'english_friendly_score': 7, 'public_transport_score': 2,
